...
export default function PrivacyEnglish() {
  return <article className={styles.prose}>
    ...
    <ul>
      <li><strong>Email address</strong> – to create an account, sign in, and send a password-reset link.</li>
      <li><strong>Mobile phone number</strong> – to verify your identity using a one-time SMS code (OTP) during registration and when changing your number.</li>
    ...
    <p><strong>2.2. Data generated through use of the Platform</strong></p>
    <ul>
    ...
    <ul>
      <li><strong>Registration, sign-in, and account management</strong> – email address, mobile number, password, and related security data enable account creation, sign-in, password resets, and account protection. The legal basis is <em>performance of a contract</em> and, for security measures, our <em>legitimate interest</em>.</li>
      ...
      <li><strong>SMS OTP verification</strong> – your mobile number is used to deliver a one-time code during registration and number changes. The basis is <em>performance of a contract</em> and our <em>legitimate interest</em> in account security.</li>
      <li><strong>Password reset by email</strong> – your email is used to send a reset link only at your request. The basis is <em>performance of a contract</em>.</li>
    ...
    <ul>
      <li><strong>Cloud-infrastructure and hosting providers</strong> – data storage and application delivery.</li><li><strong>SMS gateway</strong> – delivery of OTP codes.</li><li><strong>Push-notification service provider</strong> – delivery of notifications to your device.</li><li><strong>Email-delivery service</strong> – password-reset emails and other necessary notices.</li><li><strong>File storage</strong> – profile-photo storage.</li>
    ...
    <ul>
      <li><strong>User account and profile</strong> – retained while the account is active. After closure, data is deleted or anonymized within <strong>30 days</strong>, except data we must or may retain longer for legal obligations, fraud, complaints, or legal claims.</li>
      ...
      <li><strong>SMS OTP codes</strong> – not permanently stored and expire within minutes of sending.</li>
    </ul>
    ...
    <ul><li>TLS encryption whenever data is transferred between the application and server.</li><li>Password hashing; passwords are never stored in readable form.</li><li>Multi-step identity verification (SMS OTP) during registration and sensitive changes.</li><li>Access controls for chat messages; only authorized persons may access content when necessary for support, security, and manual report review.</li><li>Data-access controls; employees and contractors access only data required for their work.</li><li>Regular security reviews of code and infrastructure.</li><li>Server-side verification of purchase and refund status through RevenueCat before Season access is enabled or continued.</li></ul>
